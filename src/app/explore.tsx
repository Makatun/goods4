...
export default function TabTwoScreen() {
  ...
  return (
    <ScrollView
      ...
      <ThemedView className="flex-grow max-w-[800px]">
          ...
          <ExternalLink href="https://docs.expo.dev" asChild>
            <Pressable className="active:opacity-70">
              <ThemedView
                ...
                className="flex-row px-6 py-2 rounded-lg justify-center gap-1 items-center">
          ...
          <Collapsible title="Android, iOS, and web support">
            <ThemedView type="backgroundElement" className="items-center">
              ...
              <Image
                ...
                className="w-full rounded-2xl mt-2 aspect-[296/171]"
              />
            </ThemedView>
          </Collapsible>
